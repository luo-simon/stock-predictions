...
class LSTMModel(L.LightningModule):
    def __init__(self, sequence_len, input_dim, hidden_dim, num_layers, weight_decay, delta, output_dim=1):
        super().__init__()
        self.save_hyperparameters()
        self.example_input_array = torch.Tensor(64, sequence_len, input_dim) # (num_samples, seq_len, n_features)
